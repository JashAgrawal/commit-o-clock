...
export function updateSystemInstruction() {
    ...
    if (commitFormat) {
        vscode.window.showInformationMessage("Custom commit format system instruction updated");
    } else {
        vscode.window.showInformationMessage("Using default conventional commit format");
    }
}
